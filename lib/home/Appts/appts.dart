import 'package:homepage/home/Appts/data.dart';
import 'package:homepage/home/Appts/speciality.dart';
import 'package:homepage/home/Appts/doctor_info.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Image.asset("assets/doc_pic.png", height: 50,),
            SizedBox(width: 17,),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("Dr. Rahul Bose", style: TextStyle(
